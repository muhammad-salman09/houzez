...
**Caution : this plugin will disable Gutenberg Editor (default Editor beginning with WordPress 5.0) on Impacted Post types.**
...
= Can I use this plugin using new Gutenberg Editor? =

Yes, but it will disable the Gutenberg Editor on each Impacted Post type set in the settings admi page. Maybe it will be rewritten specially for the Gutenberg Editor, but this is not yet planned.
