                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select name="prop_perspective" id="prop_perspective" class="selectpicker" data-live-search="false" data-live-search-style="begins">
                            <option value=""></option>
                            <option value="north"><?php echo esc_html_e('North', 'houzez'); ?></option>
                            <option value="northeast"><?php echo esc_html_e('Northeast', 'houzez'); ?></option>
                            <option value="east"><?php echo esc_html_e('East', 'houzez'); ?></option>
                            <option value="southeast"><?php echo esc_html_e('Southeast', 'houzez'); ?></option>
                            <option value="south"><?php echo esc_html_e('South', 'houzez'); ?></option>
                            <option value="southwest"><?php echo esc_html_e('Southwest', 'houzez'); ?></option>
                            <option value="west"><?php echo esc_html_e('West', 'houzez'); ?></option>
                            <option value="northwest"><?php echo esc_html_e('Northwest', 'houzez'); ?></option>
                        </select>
                    </div>
                </div>
