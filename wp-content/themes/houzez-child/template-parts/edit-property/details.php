    ...
    <div class="add-tab-content">
        <div class="add-tab-row push-padding-bottom">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="prop_perspective"><?php esc_html_e('What direction does the front of the house face?', 'houzez'); ?></label>
                        <?php $option = $prop_meta_data['fave_perspective'][0]; ?>
                        <select name="prop_perspective" id="prop_perspective" class="selectpicker" data-live-search="false" data-live-search-style="begins">
                            <option value=""></option>
                            <option value="north" <?php if($option == 'north') echo 'selected' ?>>
                                <?php echo esc_html_e('North', 'houzez'); ?>
                            </option>
                            <option value="northeast" <?php if($option == 'northeast') echo 'selected' ?>>
                                <?php echo esc_html_e('Northeast', 'houzez'); ?>
                            </option>
                            <option value="east" <?php if($option == 'east') echo 'selected' ?>>
                                <?php echo esc_html_e('East', 'houzez'); ?>
                            </option>
                            <option value="southeast" <?php if($option == 'southeast') echo 'selected' ?>>
                                <?php echo esc_html_e('Southeast', 'houzez'); ?>
                            </option>
                            <option value="south" <?php if($option == 'south') echo 'selected' ?>>
                                <?php echo esc_html_e('South', 'houzez'); ?>
                            </option>
                            <option value="southwest" <?php if($option == 'southwest') echo 'selected' ?>>
                                <?php echo esc_html_e('Southwest', 'houzez'); ?>
                            </option>
                            <option value="west" <?php if($option == 'west') echo 'selected' ?>>
                                <?php echo esc_html_e('West', 'houzez'); ?>
                            </option>
                            <option value="northwest" <?php if($option == 'northwest') echo 'selected' ?>>
                                <?php echo esc_html_e('Northwest', 'houzez'); ?>
                            </option>
                        </select>
                    </div>
                </div>
