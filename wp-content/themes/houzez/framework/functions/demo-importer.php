...
if ( !function_exists( 'houzez_menu_revolutionslider_homepage_setup' ) ) {
    function houzez_menu_revolutionslider_homepage_setup( $demo_active_import , $demo_directory_path ) {
         ...
         * Setting Menus
         *************************************************************************/
        $wbc_menu_array = array( 'houzez01', 'houzez02', 'houzez03', 'houzez04', 'houzez05', 'houzez06', 'houzez07', 'houzez08', 'houzez09', 'houzez10', 'houzez11', 'houzez12', 'houzez13', 'houzez14', 'houzez15', 'houzez16' );
