...
Redux::setSection( $opt_name, array(
    ...
    'fields'		=> array(
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'GDPR / Terms & Conditions for forms', 'houzez' ),
            'subtitle' => esc_html__( 'Enable/Disable GDPR or terms & conditions checkbox for agent forms', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ),
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => esc_html__( 'Terms & Conditions Content', 'houzez' ),
            'subtitle' => esc_html__( 'Add terms & condition checkbox content and link', 'houzez' ),
            'required' => array('agent_forms_terms', '=', '1'),
            'default'  => 'I agree with your <a href="http://your-website.com/terms-and-condition">Terms &amp; Conditions</a>'
        ),

        array(
            'id'       => 'agent_forms_terms_validation',
            'type'     => 'text',
            'title'    => esc_html__( 'Terms & Conditions Validation Message', 'houzez' ),
            'subtitle' => esc_html__( 'Add terms & condition checkbox validation message', 'houzez' ),
            'required' => array('agent_forms_terms', '=', '1'),
            'default'  => 'You need to agree with terms & conditions.'
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        /*array(
            'id'       => 'googlemap_new_tab',
            'type'     => 'switch',
            'title'    => esc_html__( 'Property target', 'houzez' ),
            'subtitle' => esc_html__( 'Show property in new tab when click', 'houzez' ),
            'desc'     => '',
            'on'       => 'Yes',
            'off'      => 'No',
            'default'  => 0
